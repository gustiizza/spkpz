                ...
                <div class="overflow-x-auto">
                    <form action="{{ url('bobot') }}" method="POST" class="p-2">
                        <div class="grid grid-cols-2 grid-rows-1 gap-6">
                            ...
                            <x-text-input id="nilai_bk" class="block mt-1 w-full" type="number" name="nilai_bk" :value="old('nilai_bk')" required  autocomplete="nilai_bk" placeholder="Masukkan nilai sub kriteria"/>
                        </div>
                        {{-- Submit Button --}}
                        <div class="gap-6">
