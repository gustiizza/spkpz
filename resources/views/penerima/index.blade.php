                ...
                <table class="table table-xs">
                  ...
                  <tr>
                    ...
                    <td class="flex items-center justify-center py-4">
                      <a href="{{ url('/penerima/' . $pnm->id . '/edit') }}"title="Edit penerima"role="button" class="btn btn-info btn-sm items-center justify-center">Edit</a>
                        {{-- Hapups --}}
                      <button type="button" class="btn btn-error btn-sm ml-1 items-center justify-center" 
