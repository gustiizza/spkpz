                            ...
                            <div class="pr-4 pl-2 pb-2 flex justify-between text-sm">
                                <div class="dropdown dropdown-top dropdown-end ml-2">
                                    <form method="get">
                                        ...
                                        <select name="entries" class="select select-bordered" id="entries"
                                            ...
                                            <option value="100" @if (request('entries', 10) == 100) selected @endif>100
                                            </option>
                                        </select>
                                ...
                                <form method="get" action="{{ route('penerima.lihat') }}">
                                    <select name="kecamatan_id" class="select select-bordered w-full max-w-xs ml-2"
                                        id="kecamatan_id" onchange="this.form.submit()">
                                        <option value="" @if (!$selectedKecamatan) selected @endif>Tampilkan
                                            Kecamatan</option>
