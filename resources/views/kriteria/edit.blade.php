              ...
              <div class="p-4 text-gray-900">
                <div class="overflow-x-auto">
                    <form action="{{ url('kriteria/' . $kriteria->id) }}" method="post" class="p-4">
                        ...
                        <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" value="{{ $kriteria->nama }}" required autocomplete="nama" placeholder="Masukkan nama kriteria" />
                        ...
                        <div class="form-control">
                            ...
                            <div class="mt-1 flex items-center">
                                <label class="label cursor-pointer">
                                    <input type="radio" name="atribut" class="radio checked:bg-blue-500" value="cost" required  autocomplete="atribut">
                                </label>
                                <div class="label-text">Cost</div>
                            </div>
                            <div class="mt-1 flex items-center">
                                <label class="label cursor-pointer">
                                    <input type="radio" name="atribut" class="radio checked:bg-blue-500" value="benefit" required  autocomplete="atribut">
                                </label>
