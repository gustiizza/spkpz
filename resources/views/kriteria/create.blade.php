                ...
                <div class="overflow-x-auto">
                    <form action="{{ url('kriteria') }}" method="POST" class="p-4">
                        <div class="grid grid-cols-2 grid-rows-1 gap-6">
                            ...
                            <x-text-input id="kode_Kriteria" class="block mt-1 w-full" type="text" name="kode_kriteria" :value="old('nama')" required autofocus autocomplete="nama" placeholder="Masukkan kode kriteria"/>
                            <label class="label">
                            ...
                            <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="old('nama')" required autocomplete="nama" placeholder="Masukkan nama kriteria" />
                            ...
                            <div class="form-control">
                                ...
                                <div class="mt-1 flex items-center">
                                    <label class="label cursor-pointer">
                                        <input type="radio" name="atribut" class="radio checked:bg-blue-500" value="cost" required autofocus autocomplete="atribut">
                                    </label>
                                    <div class="label-text">Cost</div>
                                </div>
                                <div class="mt-1 flex items-center">
                                    <label class="label cursor-pointer">
                                        <input type="radio" name="atribut" class="radio checked:bg-blue-500" value="benefit" required autofocus autocomplete="atribut">
                                    </label>
