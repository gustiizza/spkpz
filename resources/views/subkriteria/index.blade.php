                                                        ...
                                                        <div class="modal-box">
                                                            ...
                                                            <div class="modal-action">
                                                                ...
                                                                <button type="button" class="btn btn-info"
                                                                    onclick="closeModal({{ $sk->id }})">No</button>
                                                            </div>
                                                        </div>
                                                    </dialog>
                                                    <script>
