                ...
                <div class="overflow-x-auto">
                    <form action="{{ url('subkriteria/' . $subkriteria->id) }}" method="POST" class="p-4">
                        ...
                        @method("PATCH")
                            ...
                            <x-text-input id="nama_sub_kriteria" class="block mt-1 w-full" type="text" name="nama_sub_kriteria" value="{{ $subkriteria->nama_sub_kriteria }}" required autocomplete="nama_sub_kriteria" placeholder="Masukkan nama sub kriteria" />
