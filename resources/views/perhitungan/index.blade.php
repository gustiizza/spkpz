                        ...
                        <div class="overflow-x-auto">
                            <div class="flex justify-between text-sm">
                                ...
                                <form method="get" action="{{ route('perhitungan.index') }}">
                                    <select name="kecamatan_id" class="select select-bordered w-full max-w-xs mt-4"
                                        id="kecamatan_id" onchange="this.form.submit()">
                                        <option value="" @if (!$selectedKecamatan) selected @endif>Pilih
                                            Kecamatan</option>
                            ...
                            <div class="overflow-x-auto pt-4">
                                <p
                                    class="pl-2 text-gray-900 font-medium text-base text-center underline decoration-success">
                                    Nilai Alternatif Penerima</p>
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($bobot as $bb)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $normalizedWeights[$bb->kriteria->id] ?? '' }}
                                                </td>
                                                </td>
                                            </tr>
                                        @endforeach
                                    ...
                                    <tbody>
                                        @foreach ($penerima as $pnm)
                                            @if (!$selectedKecamatan || $pnm->kecamatan_id == $selectedKecamatan)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $pnm->kecamatan->nama }}</td>
                                                    <td class="text-center">{{ 'A' . $pnm->id }}</td>
                                                    <td class="text-center">{{ number_format($vectorS[$pnm->id] ?? 0, 4) }}
                                                    </td>
                                                </tr>
                                            @endif
                                        @endforeach
                                        <tr>
                                            ...
                                            <th class="font-medium text-center">
                                                {{ number_format($vectorS->sum() ?? 0, 4) }}</th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                            ...
                                            @if (!$selectedKecamatan || $pnm->kecamatan_id == $selectedKecamatan)
                                                <tr>
                                                    ...
                                                    <td class="text-center font-bold">
                                                        {{ number_format($vectorV[$pnm->id] ?? 0, 4) }}</td>
                                                </tr>
                                            @endif
                                        @endforeach
                                    </tbody>
